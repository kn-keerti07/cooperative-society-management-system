...
<div class="content">
  <div class="header">
    <h1 class="page-title">Deposit & Withdrawal Details</h1>
  </div>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="btn-toolbar">
        <a href="transactiondet_view.php" class="btn btn-primary">
      ...
      <div class="well">
        ...
        <form method="GET" action="">
          ...
          <a href="deposite_view.php"class="btn btn-secondary">Reset</a>
        </form>
        <br>
          ...
          <tbody>
            <?php
              ...
              while ($row = mysqli_fetch_array($res)) {
                $deposit = $row['transaction_type'] == 'DEPOSIT' ? $row['amount'] : '';
                $withdrawal = $row['transaction_type'] == 'WITHDRAWAL' ? $row['amount'] : '';

                if ($deposit != '') $total_deposit += $deposit;
                if ($withdrawal != '') $total_withdrawal += $withdrawal;
            ?>
            <tr>
              <td><?php echo $sl++; ?></td>

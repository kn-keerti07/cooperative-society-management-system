...
(2, '2044367903', '2044367903', 'customer', 'Active'),
...
(2, 8, 2044367903, 2, '2025-05-05', 'Pending');
...
--
ALTER TABLE `account_holder`
  MODIFY `accountholder_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
